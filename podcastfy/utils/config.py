...
class Config:
	...
	def configure(self, **kwargs):
		...
		for key, value in kwargs.items():
			...
			elif key in ['JINA_API_KEY', 'GEMINI_API_KEY', 'OPENAI_API_KEY', 'AZURE_OPENAI_API_KEY', 'ELEVENLABS_API_KEY']:
...
def main() -> None:
	...
	missing_config = []
	for key in ['JINA_API_KEY', 'GEMINI_API_KEY', 'OPENAI_API_KEY', 'AZURE_OPENAI_API_KEY', 'ELEVENLABS_API_KEY']:
